...
`apm install --dry-run` is fully read-only: it does not create or update an
`apm.yml`, lockfile, module cache, deployment, user directory, or user config.
